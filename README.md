...
- [langgraph-implemenation](https://github.com/haroonafzaal03/langgraph-implemenation) - LangGraph implementation and experimentation.
- [money-printer-v2-forked](https://github.com/haroonafzaal03/money-printer-v2-forked) - Automated content generation workflow project.

### Web and Backend
- [extension-session-cookie](https://github.com/haroonafzaal03/extension-session-cookie) - TypeScript utility for browser session/cookie handling.
- [doorsec](https://github.com/haroonafzaal03/doorsec) - Laravel/Blade based project.
- [fleet](https://github.com/haroonafzaal03/fleet) - PHP project.
